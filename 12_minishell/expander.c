...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/22 23:21:18 by arbutnar          #+#    #+#             */
/*   Updated: 2023/03/22 23:21:21 by arbutnar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "./expander.h"

static void	expand_dollar(t_minishell *s, char buff[4095], char *(*str), int *i)
{
	char	*var_name;
	char	*var_val;
	int		c;
...
static void	expand_double_quotes(t_minishell *sh, char buff[4095],
char *(*str), int *i)
{
	if (*str[0] == '"')
	{
