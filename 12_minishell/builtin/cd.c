...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/22 23:22:51 by arbutnar          #+#    #+#             */
/*   Updated: 2023/03/22 23:22:52 by arbutnar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "./../global.h"

// cd:  if '-' is the argument go to previous folder; else error
...
// cd: if '-' is the argument go to previous fd stored in OLDPWD
...
// replace empty arg, allocate arg, store home path in first arg
...
// main cd function; return error if arg > 1; replace no arg with HOME path
